...
export const convertToStudentTimezone = (utcTime, countryName) => {
  const timezone = getTimezoneFromCountry(countryName);
  return moment(utcTime).tz(timezone);
};

// Function to format time for display
export const formatTimeForStudent = (utcTime, countryName) => {
...
export const getCurrentTimeInStudentTimezone = (countryName) => {
  const timezone = getTimezoneFromCountry(countryName);
